                    ...
                    medicineStockListModel.fetch({
                        success: function(model,response) {
                            ...
                            $('.btnAddStockToDispense').off("click").on("click",function (evt) {
                                ...
                                //Add sa List
                                let html1 = "<tr class='rowToDispenseMedicine' data-id='"+stockId+"' data-mname='"+mName+"' data-desc='"+mDesc+"' data-exp='"+mExpiration+"' data-qty='"+qty+"'>" +
                                "<td class='collapsing'>" +
                                ...
                                "<td>" + mExpiration + "</td>" +
                                // "<td>" + qty + "</td>" +
                                '<td><input type="number" value="'+qty+'" placeholder="Quantity" class="" min="'+ thisMin +'" max="'+thisMax+'"></td>'
                                "</tr>";
                    ...
                    success: function(model, response) { 
                        if (response.status == 1) {
                            let printData = {
                                ...
                                AddressSt: response.data.AddressSt,
                                FirstName: response.data.FirstName,
                                MiddleName: response.data.MiddleName,
                                LastName: response.data.LastName,
                                Image: window.bims.imageLocations + "ResidentImages/" + response.data.Image,
                                Purpose: purpose
                            }
