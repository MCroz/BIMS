...
var View = Backbone.View.extend({
    ...
    onClickCardPrint: function (e) {
        ...
        $('.resident-print-modal').modal({
            ...
            onApprove: function() {
                ...
                if (certType == "Barangay Clearance"){
                    purpose = $(".rpPurposeBC").dropdown("get value");
                } else {
                    purpose = $(".rpPurposeI").dropdown("get value")
                }
                if (purpose == "Others") {
                    purpose = $(".purposeOthers").val();
                }
        ...
        $('.rpCertificate').dropdown({
            values: [{ name : "Barangay Clearance", value: "Barangay Clearance", selected: true},
        ...
        $(".rpPurposeBC").dropdown({
            values: [
            { name : "Local Employment", value: "Local Employment", selected: true},
            { name : "SSS Requirement", value: "SSS Requirement"},
            { name : "Police Clearance Requirement", value: "Police Clearance Requirement"},
            { name : "Bank Requirement", value: "Bank Requirement"},
        ...
        $(".rpPurposeI").dropdown({
            values: [
            { name : "Financial Assistance", value: "Financial Assistance", selected: true},
            { name : "Scholarship Application", value: "Scholarship Application"},
            { name : "TUPAD Application", value: "TUPAD Application"},
            { name : "Others", value: "Others"}
                    ],
            onChange: function(value, text, $selectedItem) {
                if (value == "Barangay Clearance") {
