...
var View = Backbone.View.extend({
    ...
    onClickAddOwnerAddBusiness: function(addOwnerModal) {
        var self = this;
        $(".aobOthersKindOfBusiness").hide();
        $(".aobOthersKindOfBusiness").val("");
        ...
        $(".add-owner-add-business-modal").modal({
            onApprove: function() {
                ...
                let kindofbusiness = $(".aobKindOfBusiness").dropdown("get value");
                if (kindofbusiness == "Others") {
                    kindofbusiness = $(".aobOthersKindOfBusiness").val();
                }
                ...
                "<td>" + businessFloorArea + " sq. m<input type='hidden' value='" + businessFloorArea + "'></td>" +
        ...
        //Set Dropdown for Kind Of Business
        $(".aobKindOfBusiness").dropdown({
            values: [
                {name: "Sari-Sari Store", value: "Sari-Sari Store", selected: true},
                {name: "Grocery Store", value: "Grocery Store"},
                {name: "Drugstore", value: "Drugstore"},
                {name: "Restaurant", value: "Restaurant"},
                {name: "Carinderia", value: "Carinderia"},
                {name: "Others", value: "Others"}
            ],
            onChange: function(value, text, $selectedItem) {
                if (value == "Others") {
                    $(".aobOthersKindOfBusiness").show();
                } else {
                    $(".aobOthersKindOfBusiness").hide();
                }
            }
        ...
        getOwnerInfo.fetch({
            success: function(model, resp) {
                ...
                _.each(resp.data.OwnerBusiness, function(business) {
                    ...
                    "<td>" + business.FloorArea + " sq. m<input type='hidden' value='" + business.FloorArea + "'></td>" +
                ...
                $(".btnEditBusiness").off("click").on("click", function(e) {
                    ...
                    let kob = $(thisRow.find("input")[5]).val();
                    let valS = [
                        {name: "Sari-Sari Store", value: "Sari-Sari Store"},
                        {name: "Grocery Store", value: "Grocery Store"},
                        {name: "Drugstore", value: "Drugstore"},
                        {name: "Restaurant", value: "Restaurant"},
                        {name: "Carinderia", value: "Carinderia"},
                    ...
                    let chk = 0;
                    _.each(valS, function (valuee) {
                        if (valuee.value == kob) {
                            valuee.selected = true;
                            chk++;
                        }
                    });
                    
                    $(".eoebOthersKindOfBusiness").val("");
                    $(".eoebOthersKindOfBusiness").hide();
                    if (chk == 0) {
                        valS[5].selected = true;
                        $("eoebOthersKindOfBusiness").show();
                        $("eoebOthersKindOfBusiness").val(kob);
                    }
                    $(".eoebKindOfBusiness").dropdown({
                        values: valS,
                        onChange: function(value, text, $selectedItem) {
                            if (value == "Others") {
                                $(".eoebOthersKindOfBusiness").show();
    ...
    onClickEditOwnerAddBusiness: function (editOwnerModal) {
        var self = this;
        $(".eobOthersKindOfBusiness").hide();
        $(".eobOthersKindOfBusiness").val("");
        editOwnerModal.modal('hide');
        $(".eobForm").form("clear");
        $(".edit-owner-add-business-modal").modal({
            onApprove: function() {
                ...
                let kindofbusiness = $(".eobKindOfBusiness").dropdown("get value");
                if (kindofbusiness == "Others") {
                    kindofbusiness = $(".eobOthersKindOfBusiness").val();
                }
    ...
    onClickEditBusiness: function(thisRow,editOwnerModal) {
        ...
        $(".edit-owner-edit-business-modal").modal({
            onApprove: function() {
                ...
                let kindofbusiness1 = $(".eoebKindOfBusiness").dropdown("get value");
                if (kindofbusiness1 == "Others") {
                    kindofbusiness1 = $(".eoebOthersKindOfBusiness").val();
                }
                ...
                "<td>" + businessFloorArea1 + " sq. m<input type='hidden' value='" + businessFloorArea1 + "'></td>" +
